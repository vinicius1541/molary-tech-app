...
export function CTA() {
    return (
        <section className="bg-gradient-to-br from-primary via-primary/90 to-secondary py-20 md:py-32">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="mb-6 text-balance text-4xl font-bold text-background md:text-5xl lg:text-6xl">
                        Pronto para transformar sua clínica?
                    </h2>
                    <p className="mb-8 text-pretty text-xl text-background/80">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" className="px-8 text-lg bg-card text-primary hover:bg-card/90">
